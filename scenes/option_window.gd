...
#
	#antialiasing_option.selected = 3  # Selección predeterminada (Desactivado)
#
...
#func _on_antialiasing_selected(id):
	#match id:
		#0:
			...
			#print("_on_antialiasing_selected " + str(GameConfig.antialiasing_selected))
		#2:
			...
			#print("_on_antialiasing_selectedi " + str(GameConfig.antialiasing_selected))
		#4:
...
#func save_config():
	#var file = FileAccess.open(CONFIG_FILE, FileAccess.WRITE)
		...
		#file.store_line(str(GameConfig.antialiasing_selected))  # Guardar el valor de antialiasing
		#file.close()
...
#func load_config():
		...
		#var file = FileAccess.open(CONFIG_FILE, FileAccess.READ)
			...
			#antialiasing_selected = antialiasing_line
			#file.close()
...
func _ready():
	...
	sfx_slider.min_value = 0
	sfx_slider.max_value = 100
	sfx_slider.value = ((volume["sfx"] - (-80)) / (0 - (-80))) * 100  # Valor inicial del volumen de los efectos SFX
