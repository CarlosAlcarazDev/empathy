...
#func _ready():
	...
	#
	#for card in deck_manager.deck_re:
		#print(card.id_carta)
	#for card in deck_manager.deck_hs:
		#print(card.nombre)
...
#
	...
	#var player_card_re_1 = deck_manager.deck_re.pop_back()
	#var player_card_re_2 = deck_manager.deck_re.pop_back()
	#var player_card_re_3 = deck_manager.deck_re.pop_back()
	#var player_card_hs_1 = deck_manager.deck_hs.pop_back()
	#var player_card_hs_2 = deck_manager.deck_hs.pop_back()
	#var player_card_hs_3 = deck_manager.deck_hs.pop_back()
	#
	#var card_bullying = deck_manager.deck_bu.pop_back()
	#
	#var ai_card_re_1 = deck_manager.deck_re.pop_back()
	#var ai_card_re_2 = deck_manager.deck_re.pop_back()
	#var ai_card_re_3 = deck_manager.deck_re.pop_back()
	#var ai_card_hs_1 = deck_manager.deck_re.pop_back()
	#var ai_card_hs_2 = deck_manager.deck_re.pop_back()
	#var ai_card_hs_3 = deck_manager.deck_re.pop_back()
	#
	#
	#
	#display_card_re(player_card_re_1, re_card_1)
	#display_card_re(player_card_re_2, re_card_2)
	#display_card_re(player_card_re_3, re_card_3)
	#display_card_hs(player_card_hs_1, hs_card_1)
	#display_card_hs(player_card_hs_2, hs_card_2)
	#display_card_hs(player_card_hs_3, hs_card_3)
#
